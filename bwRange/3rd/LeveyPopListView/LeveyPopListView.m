...
#define POPLISTVIEW_HEADER_HEIGHT 50. //标题高度
#define RADIUS 5.
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    NSLog(@" levey option count %d",_options.count);
...
- (void)drawRect:(CGRect)rect {
    ...
    [ [UIColor whiteColor] setFill ]; //杯题背景
    ...
    // Draw the title and the separator with shadow //黑底蓝字
    //阴影
   ...
   // CGContextSetShadowWithColor(ctx, CGSizeMake(0, 1), 0.5f, [UIColor whiteColor].CGColor);
    [LEVEY_FONT_COLOR setFill]; //标题字体颜色
