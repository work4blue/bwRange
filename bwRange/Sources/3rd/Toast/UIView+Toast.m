...
// image view size
static const CGFloat CSToastImageViewWidth      = 60.0;
static const CGFloat CSToastImageViewHeight     = 60.0;
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        if([point caseInsensitiveCompare:@"top"] == NSOrderedSame) {
            ...
            return CGPointMake(self.bounds.size.width/2 , (self.bounds.size.height - (toast.frame.size.height / 2)) - CSToastBottomPadding);
